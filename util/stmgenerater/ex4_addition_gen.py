...
# meta settings
NORUN = False
dirname = "ex4_addition"
## settings
# array scale
basefilepath = "/home/tsunoda/pythonNeuronSimulation/testdata/ex4_addition"
dynamics = "dyn.json"
connection_def =  "nwk.json"
record_setting =  "rec.json"

timefreqlist = [0.1,0.3]
...
for tf,stim_direction in product(timefreqlist, direction_list):
    ...
    rundata["description"] = "ex4 addition " + filename + " rundata"
    rundata["v_init"] = -60
    rundata["tstop"] = 30100
