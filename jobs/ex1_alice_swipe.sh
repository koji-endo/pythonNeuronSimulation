...
SIMFILE="${EXECPATH}/testdata/opticlobe/whole10by10/run180.json"
...
#SIMFILE="${EXECPATH}/testdata/opticlobe/whole10by10/run90.json"
#mpirun python $PYTHONPROGRAM -s $SIMFILE
#SIMFILE="${EXECPATH}/testdata/opticlobe/whole10by10/run270.json"
#mpirun python $PYTHONPROGRAM -s $SIMFILE
